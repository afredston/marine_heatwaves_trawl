...
cat >! carbon_flux_plot1.jnl <<EOF
set mem/size =2048
set region/x=0E:360E
CANCEL MODE LOGO
use "bottomT_1993_2021_wo_leap_des_detrend.nc"
...
repeat/L=1:9914 (save/file="survey/all_bottom_detrend.nc"/append  baltic_sea,british_columbia,eastern_bering_sea,evhoe,fr_cgfs,gulf_of_mexico,gulf_of_alaska,gsl_s,ie_igfs,neus,nigfs,nor_bts,ns_ibts,pt_ibts,scotian_shelf,southeast,swc_ibts,west_coast)

exit
EOF

ferret -unmapped  <<EOF
    go carbon_flux_plot1.jnl 
    exit
EOF
