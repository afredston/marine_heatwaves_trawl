#!/bin/csh -f
#extracts per region the bottom temperature

cat >! mean_survey_no_detrend.jnl <<EOF
set mem/size =2048
set region/x=0E:360E
use "bottomT_1993_2020_wo_leap.nc"
...
spawn rm survey/all_1993_2020_wo_leap.nc
repeat/L=1:9914 (save/file="survey/all_1993_2020_wo_leap.nc"/append  baltic_sea,british_columbia,eastern_bering_sea,evhoe,fr_cgfs,gulf_of_mexico,gulf_of_alaska,gsl_s,ie_igfs,neus,nigfs,nor_bts,ns_ibts,pt_ibts,scotian_shelf,southeast,swc_ibts,west_coast)

exit
EOF

ferret -unmapped  <<EOF
    go mean_survey_no_detrend.jnl 
    exit
EOF
exit
