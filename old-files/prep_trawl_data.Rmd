...
setDT(namer_survey_months)[, region := stringr::str_replace_all(region, c(' Summer'="",' Fall'="",' Winter'="",' Spring'=""))]
...
setDT(namer_cpue)[, region := stringr::str_replace_all(region, c(' Summer'="",' Fall'="",' Winter'="",' Spring'=""))] # pool seasons
...
datras_cpue$accepted_name <- NULL
datras_cpue$survey <- NULL
...
```{r write out}
fwrite(namer_cpue, here("processed-data","biomass_time_namer.csv"))
fwrite(nor_cpue, here("processed-data","biomass_time_norway.csv"))
fwrite(datras_cpue, here("processed-data", "biomass_time_datras.csv"))
```
